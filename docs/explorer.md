...
When you first open _Arrest Explorer_ you will see a landing screen, this summarizes the documentation and the [Data User Agreement](/arrestexplorer/docs/user_agreement). Once you acknowledge, you will reach the _Main View_:
